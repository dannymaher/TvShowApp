...
public class DiscoverFilmsFilteringFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TmdbApi.get().getFilmService().getGenres().enqueue(new Callback<TVService.GenresContainer>() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final DiscoverFilmsFilterOptions filterOptions = viewModel.getFilmFilterOptions().getValue();

        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_discover_films_filtering, container, false);

        // sort by
        Spinner sortBySpinner = view.findViewById(R.id.sort_by_spinner);
        ArrayAdapter sortSpinnerAdapter = new ArrayAdapter<>(getContext(),
                android.R.layout.simple_spinner_item, DiscoverFilmsFilterOptions.SortOption.values());
    ...
    public void saveOptions() {
        DiscoverFilmsFilterOptions filterOptions = new DiscoverFilmsFilterOptions();

        // sort by
        Spinner sortBySpinner = getView().findViewById(R.id.sort_by_spinner);
        DiscoverFilmsFilterOptions.SortOption sortBy = (DiscoverFilmsFilterOptions.SortOption) sortBySpinner.getSelectedItem();
        ...
        FilterOptionsViewModel viewModel = new ViewModelProvider(requireActivity()).get(FilterOptionsViewModel.class);
        viewModel.getFilmFilterOptions().setValue(filterOptions);
    }
}
