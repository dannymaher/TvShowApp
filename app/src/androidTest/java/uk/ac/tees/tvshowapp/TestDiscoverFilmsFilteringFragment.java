...
import uk.ac.tees.tvshowapp.fragments.DiscoverFilmsFilteringFragment;
...
public class TestDiscoverFilmsFilteringFragment {

    @Before
    public void setupFragment() {
        TmdbApi.get().setRetrofit(TmdbMock.getMockRetrofit());

        FragmentScenario.launchInContainer(DiscoverFilmsFilteringFragment.class);
    }
